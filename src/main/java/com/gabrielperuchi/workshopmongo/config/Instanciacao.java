...
public class Instanciacao implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Postagem postagem1 = new Postagem(null, sdf.parse("21/03/2018"), "Partiu viagem",
				"Vou viajar para São Paulo. Abraços!", new AutorDTO(gabriel));
		Postagem postagem2 = new Postagem(null, sdf.parse("23/03/2018"), "Bom dia", "Acordei feliz hoje!",
				new AutorDTO(gabriel));

		ComentarioDTO comentario1 = new ComentarioDTO("Boa viagem mano!", sdf.parse("21/03/2018"),
				new AutorDTO(carlos));
		ComentarioDTO comentario2 = new ComentarioDTO("Aproveita!", sdf.parse("22/03/2018"), new AutorDTO(maria));
		ComentarioDTO comentario3 = new ComentarioDTO("Tenha um ótimo dia! :)", sdf.parse("23/03/2018"),
				new AutorDTO(carlos));

		postagem1.getComentarios().addAll(Arrays.asList(comentario1, comentario2));
		postagem2.getComentarios().add(comentario3);
